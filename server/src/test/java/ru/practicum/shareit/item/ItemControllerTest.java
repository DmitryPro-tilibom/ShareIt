...
class ItemControllerTest {
    ...
    private final ItemDto itemDto = new ItemDto(
            ...
            "cool item",
            true,
            new UserDtoIdName(1L, "User"));

    @Test
    void saveNewItem() throws Exception {
        when(itemService.saveNewItem(any(), anyLong())).thenReturn(itemDto);
    ...
    void getItemsByOwner() throws Exception {
        when(itemService.getItemsByOwner(anyInt(), anyInt(), anyLong())).thenReturn(List.of(itemDto));
    ...
    void getFilmBySearch() throws Exception {
        when(itemService.getItemBySearch(any(), any(), any())).thenReturn(List.of(itemDto));
